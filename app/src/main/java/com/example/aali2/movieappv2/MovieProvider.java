...
public class MovieProvider  extends ContentProvider{
    static final String AUTHORITY_NAME="com.example.aali2.movieappv2";
    static final String URL="content://"+AUTHORITY_NAME+"/movies";
    ...
    static{
        ...
        uriMatcher.addURI(AUTHORITY_NAME, "movies", MOVIES);
        uriMatcher.addURI(AUTHORITY_NAME, "movies/#", MOVIES_ID);
    }
